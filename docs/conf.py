...
"""
edx_event_bus_redis documentation build configuration file.
...
# documentation.
html_theme_options = {
    "repository_url": "https://github.com/openedx/event-bus-redis",
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Redis Streams implementation for the Open edX event bus.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'src/edx_event_bus_redis'),
                os.path.join(root_path, 'src/edx_event_bus_redis/migrations')])
